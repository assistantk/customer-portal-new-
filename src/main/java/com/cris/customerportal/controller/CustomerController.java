...
public class CustomerController { private final CustomerService service; public CustomerController(CustomerService s){service=s;}
 ...
 @GetMapping("/global-lookup") public com.cris.customerportal.dto.GlobalAgentResponse lookupGlobal(@RequestParam String code){return service.lookupGlobalCustomerByCode(code);}
