...
public class CustomerController { private final CustomerService service; public CustomerController(CustomerService s){service=s;}
 ...
 @GetMapping("/gstin-lookup") public com.cris.customerportal.dto.OldCustomerResponse lookupGstin(@RequestParam String gstin){return service.lookupOldCustomerByGstin(gstin);}
