...
public class CustomerPortalApplication {
  static {
    ...
    System.setProperty("http.nonProxyHosts", "localhost|127.0.0.1|*.crisexacc.org|tndexaccvm-scan.crisexacc.org|db.internal.net");
    System.setProperty("socksNonProxyHosts", "localhost|127.0.0.1|*.crisexacc.org|tndexaccvm-scan.crisexacc.org|db.internal.net");
  }
