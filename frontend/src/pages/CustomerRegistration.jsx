...
const divisionsByZone = {
    ...
    'East Coast Railway (ECO)': ['Khurda Road (KUR)', 'Sambalpur (SBP)', 'Rayagada (RGDA)', 'WALTAIR (WAT)'],
    'Northern Railway (NR)': ['Delhi (DLI)', 'Ambala (UMB)', 'Firozpur (FZR)', 'Lucknow (LKO)', 'Moradabad (MB)', 'Jammu (JAT)'],
