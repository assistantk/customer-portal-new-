...
import {Building2,Tag,MapPin,FileText,UploadCloud,Globe,Mail,Phone,ShieldCheck,RotateCcw,Send,UserRound,ChevronDown} from 'lucide-react';
...
export default function CustomerRegistration() {
 ...
 return <div className="app">
  <header><div className="brand"><div className="seal left-cris"><img src={crisLogo} alt="CRIS – making IT happen"/></div><span>CUSTOMER REGISTRATION PORTAL</span></div><div className="header-railways"><img src={indianRailwaysLogo} alt="Indian Railways"/></div><div className="cris"><img src={crisLogo} alt="CRIS – making IT happen"/></div></header>
  <main><form className="card" onSubmit={submit}>
   <div className="card-head"><div className="title-icon"><UserRound/><div><h1>Customer Registration</h1><p>Enter customer account information</p></div></div><button type="button" className="new" onClick={reset}>+ New Entry</button></div><div className="rule"/>
